 ...
 *                            E - Commands
 *
 * What follows are all of the "E-Command" functions.  These are the functions
 * that are executed when "vitunes -e COMMAND" is entered.
 * The name of each function is preceded with "ecmd_", and each takes the
