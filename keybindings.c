...
const KeyActionName KeyActionNames[] = {
   { scroll_up_e,               "scroll_up" },
   { scroll_down_e,             "scroll_down" },
   { scroll_up_page_e,          "scroll_up_page" },
   { scroll_down_page_e,        "scroll_down_page" },
   { scroll_up_halfpage_e,      "scroll_up_halfpage" },
   { scroll_down_halfpage_e,    "scroll_down_halfpage" },
   { scroll_up_wholepage_e,     "scroll_up_wholepage" },
   { scroll_down_wholepage_e,   "scroll_down_wholepage" },
   { scroll_left_e,             "scroll_left" },
   { scroll_right_e,            "scroll_right" },
   { scroll_leftmost_e,         "scroll_leftmost" },
   { scroll_rightmost_e,        "scroll_rightmost" },
   { jumpto_screen_top_e,       "jumpto_screen_top" },
   { jumpto_screen_middle_e,    "jumpto_screen_middle" },
   { jumpto_screen_bottom_e,    "jumpto_screen_bottom" },
   { jumpto_line_e,             "jumpto_line" },
   { jumpto_percent_e,          "jumpto_percent" },
   { search_forward_e,          "search_forward" },
   { search_backward_e,         "search_backward" },
   { find_next_forward_e,       "find_next_forward" },
   { find_next_backward_e,      "find_next_backward" },
   { visual_e,                  "visual" },
   { cut_e,                     "cut" },
   { yank_e,                    "yank" },
   { paste_after_e,             "paste_after" },
   { paste_before_e,            "paste_before" },
   { undo_e,                    "undo" },
   { redo_e,                    "redo" },
   { go_e,                      "go" },
   { quit_e,                    "quit" },
   { redraw_e,                  "redraw" },
   { command_mode_e,            "command_mode" },
   { shell_e,                   "shell" },
   { switch_windows_e,          "switch_window" },
   { show_file_info_e,          "show_file_info" },
   { load_playlist_e,           "load_playlist" },
   { media_play_e,              "media_play" },
   { media_pause_e,             "media_pause" },
   { media_stop_e,              "media_stop" },
   { media_next_e,              "media_next" },
   { media_prev_e,              "media_prev" },
   { volume_increase_e,         "volume_increase" },
   { volume_decrease_e,         "volume_decrease" },
   { seek_forward_seconds_e,    "seek_forward_seconds" },
   { seek_backward_seconds_e,   "seek_backward_seconds" },
   { seek_forward_minutes_e,    "seek_forward_minutes" },
   { seek_backward_minutes_e,   "seek_backward_minutes" },
   { toggle_forward_e,          "toggle_forward" },
   { toggle_backward_e,         "toggle_backward" }
};
...
{ scroll_up_e,             kba_scroll_row,     true,  { .direction = UP }},
{ scroll_down_e,           kba_scroll_row,     true,  { .direction = DOWN }},
{ scroll_up_page_e,        kba_scroll_page,    true,  { .direction = UP,   .amount = SINGLE }},
{ scroll_down_page_e,      kba_scroll_page,    true,  { .direction = DOWN, .amount = SINGLE }},
{ scroll_up_halfpage_e,    kba_scroll_page,    true,  { .direction = UP,   .amount = HALF }},
{ scroll_down_halfpage_e,  kba_scroll_page,    true,  { .direction = DOWN, .amount = HALF }},
{ scroll_up_wholepage_e,   kba_scroll_page,    true,  { .direction = UP,   .amount = WHOLE }},
{ scroll_down_wholepage_e, kba_scroll_page,    true,  { .direction = DOWN, .amount = WHOLE }},
{ scroll_left_e,           kba_scroll_col,     true,  { .direction = LEFT,  .amount = SINGLE }},
{ scroll_right_e,          kba_scroll_col,     true,  { .direction = RIGHT, .amount = SINGLE }},
{ scroll_leftmost_e,       kba_scroll_col,     true,  { .direction = LEFT,  .amount = WHOLE }},
{ scroll_rightmost_e,      kba_scroll_col,     true,  { .direction = RIGHT, .amount = WHOLE }},
{ jumpto_screen_top_e,     kba_jumpto_screen,  true,  { .placement = TOP }},
{ jumpto_screen_middle_e,  kba_jumpto_screen,  true,  { .placement = MIDDLE }},
{ jumpto_screen_bottom_e,  kba_jumpto_screen,  true,  { .placement = BOTTOM }},
{ jumpto_line_e,           kba_jumpto_file,    true,  { .scale = NUMBER, .num = 'G' }},
{ jumpto_percent_e,        kba_jumpto_file,    true,  { .scale = PERCENT }},
{ search_forward_e,        kba_search,         true,  { .direction = FORWARDS }},
{ search_backward_e,       kba_search,         true,  { .direction = BACKWARDS }},
{ find_next_forward_e,     kba_search_find,    true,  { .direction = SAME }},
{ find_next_backward_e,    kba_search_find,    true,  { .direction = OPPOSITE }},
{ visual_e,                kba_visual,         true,  ARG_NOT_USED },
{ cut_e,                   kba_cut,            true,  ARG_NOT_USED },
{ yank_e,                  kba_yank,           true,  ARG_NOT_USED },
{ paste_after_e,           kba_paste,          false, { .placement = AFTER }},
{ paste_before_e,          kba_paste,          false, { .placement = BEFORE }},
{ undo_e,                  kba_undo,           false, ARG_NOT_USED },
{ redo_e,                  kba_redo,           false, ARG_NOT_USED },
{ go_e,                    kba_go,             true,  ARG_NOT_USED },
{ quit_e,                  kba_quit,           false, ARG_NOT_USED },
{ redraw_e,                kba_redraw,         false, ARG_NOT_USED },
{ command_mode_e,          kba_command_mode,   false, ARG_NOT_USED },
{ shell_e,                 kba_shell,          false, ARG_NOT_USED },
{ switch_windows_e,        kba_switch_windows, false, ARG_NOT_USED },
{ show_file_info_e,        kba_show_file_info, false, ARG_NOT_USED },
{ load_playlist_e,         kba_load_playlist,  false, ARG_NOT_USED },
{ media_play_e,            kba_play,           false, ARG_NOT_USED },
{ media_pause_e,           kba_pause,          false, ARG_NOT_USED },
{ media_stop_e,            kba_stop,           false, ARG_NOT_USED },
{ media_next_e,            kba_play_next,      false, ARG_NOT_USED },
{ media_prev_e,            kba_play_prev,      false, ARG_NOT_USED },
{ volume_increase_e,       kba_volume,         false, { .direction = FORWARDS }},
{ volume_decrease_e,       kba_volume,         false, { .direction = BACKWARDS }},
{ seek_forward_seconds_e,  kba_seek,           false, { .direction = FORWARDS,  .scale = SECONDS, .num = 10 }},
{ seek_backward_seconds_e, kba_seek,           false, { .direction = BACKWARDS, .scale = SECONDS, .num = 10 }},
{ seek_forward_minutes_e,  kba_seek,           false, { .direction = FORWARDS,  .scale = MINUTES, .num = 1 }},
{ seek_backward_minutes_e, kba_seek,           false, { .direction = BACKWARDS, .scale = MINUTES, .num = 1 }},
{ toggle_forward_e,        kba_toggle,         false, { .direction = FORWARDS }},
{ toggle_backward_e,       kba_toggle,         false, { .direction = BACKWARDS }}
};
...
const KeyBinding DefaultKeyBindings[] = {
   ...
   { KEY_UP,            scroll_up_e },
   { 'j',               scroll_down_e },
   { KEY_DOWN,          scroll_down_e },
   { kb_CONTROL('y'),   scroll_up_page_e },
   { kb_CONTROL('e'),   scroll_down_page_e },
   { kb_CONTROL('u'),   scroll_up_halfpage_e },
   { kb_CONTROL('d'),   scroll_down_halfpage_e },
   { kb_CONTROL('b'),   scroll_up_wholepage_e },
   { KEY_PPAGE,         scroll_up_wholepage_e },
   { kb_CONTROL('f'),   scroll_down_wholepage_e },
   { KEY_NPAGE,         scroll_down_wholepage_e },
   { 'h',               scroll_left_e },
   { KEY_LEFT,          scroll_left_e },
   { KEY_BACKSPACE,     scroll_left_e },
   { 'l',               scroll_right_e },
   { KEY_RIGHT,         scroll_right_e },
   { ' ',               scroll_right_e },
   { '^',               scroll_leftmost_e },
   { '0',               scroll_leftmost_e },
   { '|',               scroll_leftmost_e },
   { '$',               scroll_rightmost_e },
   { 'H',               jumpto_screen_top_e },
   { 'M',               jumpto_screen_middle_e },
   { 'L',               jumpto_screen_bottom_e },
   { 'G',               jumpto_line_e },
   { '%',               jumpto_percent_e },
   { '/',               search_forward_e },
   { '?',               search_backward_e },
   { 'n',               find_next_forward_e },
   { 'N',               find_next_backward_e },
   { 'v',               visual_e },
   { 'V',               visual_e },
   { 'd',               cut_e },
   { 'y',               yank_e },
   ...
   { kb_CONTROL('c'),   quit_e },
   { kb_CONTROL('/'),   quit_e },
   { kb_CONTROL('l'),   redraw_e },
   { ':',               command_mode_e },
   { '!',               shell_e },
   { MY_K_TAB,          switch_windows_e },
   { 'm',               show_file_info_e },
   { MY_K_ENTER,        load_playlist_e },
   { MY_K_ENTER,        media_play_e },
   { 'z',               media_pause_e },
   { 's',               media_stop_e },
   { 'f',               seek_forward_seconds_e },
   { ']',               seek_forward_seconds_e },
   { 'b',               seek_backward_seconds_e },
   { '[',               seek_backward_seconds_e },
   { 'F',               seek_forward_minutes_e },
   { '}',               seek_forward_minutes_e },
   { 'B',               seek_backward_minutes_e },
